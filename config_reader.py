...
class ReadMatrixFromFile(Module):
...
This module is used to read matrix in DATA format from a file.This format is used in VisPipeline
...
The output is a matrix that can be used in visualization modules. 
